    ...
    <div class="main1">
       <?php
         ...
         if(isset($_GET['author'])){
           $user_id = mysqli_real_escape_string($conn, $_GET['author']);
         }
         include 'connection.php';
         if(isset($_GET['page'])){
      ...
      <div id="pagination">
        <ul>
          <?php
            ...
            if($page > 1){
              echo '<li><a href="author.php?author='.$user_id.'&page='.($page-1).'">Prev</a></li>';
            }
            for($i = 1; $i <= $total_page; $i++){
              ...
              echo '<li><a class='.$active.' href="author.php?author='.$user_id.'&page='.$i.'">'.$i.'</a></li>';
            }
            if($page < $total_page){
              echo '<li><a href="author.php?author='.$user_id.'&page='.($page+1).'">Next</a></li>';
            }
          ?>
        </ul>
      </div>
